...
Refactor visual de la pantalla de Login. Se estableció la base visual del módulo de autenticación con nueva arquitectura de componentes, paleta de colores coherente con el design system y estructura responsiva.
