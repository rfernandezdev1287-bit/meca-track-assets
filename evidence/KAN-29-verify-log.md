...
Implementación de botones translúcidos en formulario de Login. Se diseñaron e implementaron los botones de acción con efecto glassmorphism base, aplicando backdrop-filter, opacidad y bordes sutiles coherentes con el design token system.
