...
* **Ticket Asociado:** KAN-51
* **Fecha de Ejecución:** lunes, 25 de mayo de 2026, 23:35:01 CST
...
```text
 ...
 Test Files  5 passed (5)
      Tests  66 passed (66)
   Start at  23:34:04
   Duration  9.11s (transform 138ms, setup 69ms, import 1.28s, tests 7.19s, environment 0ms)
```
...
```text
 ...
 Test Files  6 passed (6)
      Tests  23 passed (23)
   Start at  23:34:13
   Duration  6.10s (transform 675ms, setup 0ms, import 8.44s, tests 974ms, environment 6.10s)
```
